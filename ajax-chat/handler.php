 ...
 */
$db = new PDO('mysql:host=localhost;dbname=chat;charset=utf8', 'root', '101419', [
...
if(array_key_exists("task", $_GET)){//chercher dans le tableau $_GET la clef task
  $task = $_GET['task'];
}
...
function getMessages(){
  global $db;//car $db est défini à l exterieur
...
function postMessage(){
  ...
  if(!array_key_exists('author', $_POST) || !array_key_exists('content', $_POST)){//si on n envoi rien
